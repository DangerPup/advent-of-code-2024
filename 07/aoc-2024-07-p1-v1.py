...
while(i<lResults.__len__()):
    ...
    # Not ideal, but I think I'll start by hard-coding this for the example and maybe some patterns will emerge where I can write a function.
    if(positionCount==0):
        lPermuations=[]
        pass
